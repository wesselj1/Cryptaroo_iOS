...
@interface MGSplitViewController : UIViewController <UIPopoverControllerDelegate> {
    ...
    UIBarButtonItem *_helpBtn;
    UIBarButtonItem *_flexSpace;
    UIBarButtonItem *_rightSpacing;
...
@property (nonatomic) IBOutlet UIViewController *masterViewController; // convenience.
@property (nonatomic) IBOutlet UIViewController *detailViewController; // convenience.
@property (nonatomic) MGSplitDividerView *dividerView; // the view which draws the divider/split between master and detail.
...
@property (nonatomic, strong) UIPopoverController *_hiddenPopoverController;
@property (nonatomic, strong) UIPopoverController *_infoPopoverController;
@property (nonatomic, strong) UIBarButtonItem *menuButton;
@property (nonatomic, strong) UIBarButtonItem *_infoBtn;
@property (nonatomic, strong) UIBarButtonItem *_helpBtn;
@property (nonatomic, strong) UIBarButtonItem *_flexSpace;
@property (nonatomic, strong) UIBarButtonItem *_rightSpacing;
@property (nonatomic, strong) UIBarButtonItem *_smallSpace;
