...
@synthesize _hiddenPopoverController;
@synthesize _infoPopoverController;
@synthesize toolbar;
@synthesize menuButton;
@synthesize _infoBtn;
@synthesize _helpBtn;
@synthesize _flexSpace;
@synthesize _rightSpacing;
@synthesize _smallSpace;
...
- (void)displayInfoPopover:(UIViewController *)view
{
    [_infoPopoverController dismissPopoverAnimated:YES];
    
    CGRect rect = [_infoBtn customView].frame;
    rect.size.width = 18;
    rect.origin.x += 0;
    
    _infoPopoverController = [[UIPopoverController alloc] initWithContentViewController:view];
    [_infoPopoverController setPopoverContentSize:CGSizeMake(320, 460)];
    _infoPopoverController.popoverBackgroundViewClass = [KSCustomPopoverBackgroundView class];
    
    [_infoPopoverController presentPopoverFromRect:rect inView:self.view permittedArrowDirections:UIPopoverArrowDirectionUp animated:YES];
    //[_infoPopoverController presentPopoverFromBarButtonItem:[self.toolbar.items objectAtIndex:2] permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
}
...
- (void)layoutSubviewsForInterfaceOrientation:(UIInterfaceOrientation)theOrientation withAnimation:(BOOL)animate
{
	...
	CGRect newFrame = CGRectMake(0, 44, width, height-44);
...
- (void)reconfigureForMasterInPopover:(BOOL)inPopover
{
	...
	if (inPopover && !_hiddenPopoverController && !_barButtonItem) {
        ...
        _hiddenPopoverController.popoverBackgroundViewClass = [KSCustomPopoverBackgroundView class];
        ...
        [_hiddenPopoverController setPopoverContentSize:CGSizeMake(320, 460)];
...
- (IBAction)showMasterPopover:(id)sender
{
	...
	if (_hiddenPopoverController && !(_hiddenPopoverController.popoverVisible)) {
        ...
        [_hiddenPopoverController presentPopoverFromBarButtonItem:[self.toolbar.items objectAtIndex:0] permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
	}
}
