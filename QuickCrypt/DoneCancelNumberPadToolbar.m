...
- (id) initWithTextField:(UITextField *)aTextField
{
    ...
    if (self) {
        ...
        self.doneButton = [[UIBarButtonItem alloc] initWithTitle:@"Done" style:UIBarButtonItemStyleDone target:self action:@selector(doneWithNumberPad)];
        ...
        if( SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0") ) {
            ...
            _doneButton.tintColor = [UIColor colorWithRed:75/255.0 green:155/255.0 blue:255/255.0 alpha:1.0];
